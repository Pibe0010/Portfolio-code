  ...
  return (
    <section className="card">
      ...
      <p className="card-descr">
        Base de datos MYSQL para la gestión de una tienda online, con carrito de compras y
        un sistema de pagos seguro, con un panel de administración para agregar, editar y
        eliminar productos de la tienda online.
      </p>
