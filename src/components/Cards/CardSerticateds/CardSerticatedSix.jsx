    ...
    <div className="card__serticated">
      ...
      <div className="card__content">
        ...
        <p className="card__description">
          De cero. WordPress. Dónde trabajamos con WordPress, usamos las tecnologías y
          Plugins como WordPress, Elementor, Paypal, PHP, Yoast SEO, WPForms Lite, WP Mail
          SMTP, WP Show Posts, Adapta RGPD
        </p>
        <p className="card__start">Inicio: 27-9-2023</p>
        <p className="card__end">Fin: 29-9-2023</p>
        <section className="card__Loader">
          <img src={wordPress} className="card-tech-img" alt="Icono wordpress"></img>
          <img src={php} className="card-tech-img" alt="Icono php"></img>
        </section>
      </div>
    </div>
  );
